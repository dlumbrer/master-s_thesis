...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm, keepaspectratio]{TFM/img/results/exampledash2.png}
  \caption{Modal add chart to a dashboard}
  \label{fig:onlynodes}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=16cm, keepaspectratio]{TFM/img/results/exampledashaloneVRmobile.png}
  \caption{Modal add chart to a dashboard}
  \label{fig:onlynodes}
\end{figure}
